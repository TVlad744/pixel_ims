...
/** A port discovered on the local network via mDNS (Wireless Debugging). */
...
/**
 * Discovers the device's own Wireless Debugging connect/pairing ports via Network Service
 * Discovery (mDNS) and emits them as a cold [Flow]. Discovery stops automatically when the
 * collector is canceled.
 */
        ...
        override fun onServiceFound(serviceInfo: NsdServiceInfo) {
            ...
            nsdManager.resolveService(serviceInfo, object : NsdManager.ResolveListener {
                ...
                override fun onServiceResolved(info: NsdServiceInfo) {
                    Log.d(TAG, "Resolved $serviceTypeMatch port ${info.port}")
